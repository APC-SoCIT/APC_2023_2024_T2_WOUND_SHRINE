<template>
  ...
  <q-card-section class="q-pt-xs">
    ...
    <div class="row justify-center">
      ...
      <span class="text-caption" @click="goToRegister" style="cursor: pointer; color: #3851ff;">Register here</span>
    </div>
  </q-card-section>
  <!-- </q-form> -->
</template>
...
function goToRegister() {
  router.push('/Register') // Assuming the route for register form is '/register'
}
</script>
