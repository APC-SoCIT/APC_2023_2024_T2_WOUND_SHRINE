...
module.exports.getAll = (id) => {
    ...
    return new Promise((resolve, reject) => {
      db.execute(`SELECT * FROM baptism where user_id = ?`, id)
        .then(data => {
          resolve(data);
        })
        .catch(err => {
  ...
  module.exports.create = payload => {
    ...
    return new Promise((resolve, reject) => {
      db.execute(`INSERT INTO baptism SET ?`, payload)
        .then(data => {
  ...
  module.exports.updateByID = (id, payload) => {
    ...
    logger.log('info', `${TAG}${ACTION}`, id);
    return new Promise((resolve, reject) => {
      db.execute(`UPDATE baptism SET ? WHERE id = ?`, [payload
    , id])
        .then(data => {
          resolve(data);
        })
  ...
  module.exports.getByID = (id) => {
    ...
    logger.log('info', `${TAG}${ACTION}`, id);
    return new Promise((resolve, reject) => {
      db.execute(`SELECT * FROM baptism where id = ?`, id)
        .then(data => {
          resolve(data[0]);
        })
        .catch(err => {
